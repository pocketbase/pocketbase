import{S as St,i as At,s as Lt,ab as Mt,ac as Ht,O as Y,h as d,d as Re,t as Z,a as x,I as jt,ad as Pt,ae as Nt,C as Ut,af as Jt,D as zt,l as u,n as t,m as Te,E as Gt,G as Kt,u as a,A as _,v as i,c as Pe,w as b,J as Ft,p as Wt,k as ee,o as Qt}from"./index-B4ZsHsKR.js";function Bt(o,s,n){const c=o.slice();return c[6]=s[n],c}function Et(o,s,n){const c=o.slice();return c[6]=s[n],c}function Ot(o,s){let n,c,y;function f(){return s[5](s[6])}return{key:o,first:null,c(){n=a("button"),n.textContent=`${s[6].code} `,b(n,"class","tab-item"),ee(n,"active",s[1]===s[6].code),this.first=n},m(r,h){u(r,n,h),c||(y=Qt(n,"click",f),c=!0)},p(r,h){s=r,h&10&&ee(n,"active",s[1]===s[6].code)},d(r){r&&d(n),c=!1,y()}}}function It(o,s){let n,c,y,f;return c=new Ht({props:{content:s[6].body}}),{key:o,first:null,c(){n=a("div"),Pe(c.$$.fragment),y=i(),b(n,"class","tab-item"),ee(n,"active",s[1]===s[6].code),this.first=n},m(r,h){u(r,n,h),Te(c,n,null),t(n,y),f=!0},p(r,h){s=r,(!f||h&10)&&ee(n,"active",s[1]===s[6].code)},i(r){f||(x(c.$$.fragment,r),f=!0)},o(r){Z(c.$$.fragment,r),f=!1},d(r){r&&d(n),Re(c)}}}function Vt(o){var pt,mt,bt,ht,ft,_t,yt,kt;let s,n,c=o[0].name+"",y,f,r,h,F,g,U,Fe,P,B,Be,E,Ee,Oe,te,le,w,ae,O,oe,I,se,H,ne,J,ie,q,ce,Ie,re,S,z,He,k,G,Se,de,Ae,D,K,Le,ue,Me,W,je,pe,Ne,C,Ue,me,Je,ze,Ge,Q,Ke,V,We,be,Qe,he,Ve,fe,Xe,p,_e,Ye,ye,Ze,ke,xe,$e,et,ge,tt,ve,lt,at,ot,De,st,R,Ce,A,we,T,L,v=[],nt=new Map,it,M,$=[],ct=new Map,j,qe,rt;w=new Mt({props:{js:`
    ...
    File upload is supported only via <em>multipart/form-data</em> (see below for more details).`,ie=i(),q=a("table"),ce=a("thead"),ce.innerHTML='<tr><th>Param</th> <th width="80%">Description</th></tr>',Ie=i(),re=a("tbody"),S=a("tr"),z=a("td"),z.innerHTML='<div class="flex txt-nowrap"><span class="label label-success">Required</span> <span>requests</span></div>',He=i(),k=a("td"),G=a("span"),G.textContent="Array<Request>",Se=_(` - List of the requests to process.
                ...
                `),de=a("p"),de.textContent="The supported batch request actions are:",Ae=i(),D=a("ul"),K=a("li"),Le=_("record create - "),ue=a("code"),ue.textContent="POST /api/collections/{collection}/records",Me=i(),W=a("li"),je=_(`record update -
    ...
    `),w.$set(m);const $t={};l&1&&($t.content=`
                            ...
                            // file for the second request
                            formData.append("requests.1.someFileField", new File(...))
                        `),R.$set($t),l&10&&(X=Y(e[3]),v=Pt(v,l,dt,1,e,X,nt,L,Nt,Ot,null,Et)),l&10&&(N=Y(e[3]),Ut(),$=Pt($,l,ut,1,e,N,ct,M,Jt,It,null,Bt),zt())},i(e){if(!j){x(w.$$.fragment,e),x(R.$$.fragment,e);for(let l=0;l<N.length;l+=1)x($[l]);j=!0}},o(e){Z(w.$$.fragment,e),Z(R.$$.fragment,e);for(let l=0;l<$.length;l+=1)Z($[l]);j=!1},d(e){e&&(d(s),d(r),d(h),d(F),d(g),d(le),d(ae),d(O),d(oe),d(I),d(se),d(H),d(ne),d(J),d(ie),d(q),d(Ce),d(A),d(we),d(T)),Re(w,e),Re(R);for(let l=0;l<v.length;l+=1)v[l].d();for(let l=0;l<$.length;l+=1)$[l].d();qe=!1,rt()}}}function Xt(o,s,n){let c,y,{collection:f}=s,r=200,h=[];const F=g=>n(1,r=g.code);return o.$$set=g=>{"collection"in g&&n(0,f=g.collection)},o.$$.update=()=>{o.$$.dirty&1&&n(4,y=Ft.dummyCollectionRecord(f)),o.$$.dirty&17&&f!=null&&f.id&&(h.push({code:200,body:JSON.stringify([{status:200,body:y},{status:200,body:Object.assign({},y,{id:y.id+"2"})}],null,2)}),h.push({code:400,body:`
                {
                  "status": 400,
