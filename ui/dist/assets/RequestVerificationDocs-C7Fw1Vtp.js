import{S as qe,i as we,s as ye,O as F,b as r,d as ve,t as x,a as ee,r as I,Q as pe,R as Pe,g as Be,T as Ce,e as Se,f as d,h as n,m as ge,n as f,u as g,k as h,c as $e,o as b,C as Te,p as Re,w as L,x as Ve,N as Me}from"./index-CRh7dlL-.js";import{S as Ae}from"./SdkTabs-C6hORRCs.js";function be(o,l,s){const a=o.slice();return a[5]=l[s],a}function _e(o,l,s){const a=o.slice();return a[5]=l[s],a}function ke(o,l){let s,a=l[5].code+"",_,p,i,u;function m(){return l[4](l[5])}return{key:o,first:null,c(){s=f("button"),_=g(a),p=h(),b(s,"class","tab-item"),L(s,"active",l[1]===l[5].code),this.first=s},m($,q){d($,s,q),n(s,_),n(s,p),i||(u=Ve(s,"click",m),i=!0)},p($,q){l=$,q&4&&a!==(a=l[5].code+"")&&I(_,a),q&6&&L(s,"active",l[1]===l[5].code)},d($){$&&r(s),i=!1,u()}}}function he(o,l){let s,a,_,p;return a=new Me({props:{content:l[5].body}}),{key:o,first:null,c(){s=f("div"),$e(a.$$.fragment),_=h(),b(s,"class","tab-item"),L(s,"active",l[1]===l[5].code),this.first=s},m(i,u){d(i,s,u),ge(a,s,null),n(s,_),p=!0},p(i,u){l=i;const m={};u&4&&(m.content=l[5].body),a.$set(m),(!p||u&6)&&L(s,"active",l[1]===l[5].code)},i(i){p||(ee(a.$$.fragment,i),p=!0)},o(i){x(a.$$.fragment,i),p=!1},d(i){i&&r(s),ve(a)}}}function Ue(o){var de,fe;let l,s,a=o[0].name+"",_,p,i,u,m,$,q,j=o[0].name+"",N,te,Q,w,z,C,G,y,D,le,H,S,se,J,O=o[0].name+"",K,ae,W,T,X,R,Y,V,Z,P,M,v=[],oe=new Map,ne,A,k=[],ie=new Map,B;w=new Ae({props:{js:`
