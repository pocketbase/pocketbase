import{S as Ze,i as tl,s as el,q as Qe,b as u,f as m,x as ll,n as e,k as s,E as sl,o as a,h as t,u as _,N as Fe,O as se,d as Qt,P as nl,t as $t,a as Ct,r as ke,Q as Ue,R as ol,g as al,T as il,e as rl,m as Ut,c as jt,C as ve,p as cl,w as Le}from"./index-Bm5ulYjt.js";import{S as dl}from"./SdkTabs-BfDgzTqs.js";import{F as pl}from"./FieldsQueryParam-Dj7YrJ7L.js";function fl(d){let n,o,i;return{c(){n=e("span"),n.textContent="Show details",o=s(),i=e("i"),a(n,"class","txt"),a(i,"class","ri-arrow-down-s-line")},m(f,h){m(f,n,h),m(f,o,h),m(f,i,h)},d(f){f&&(u(n),u(o),u(i))}}}function ul(d){let n,o,i;return{c(){n=e("span"),n.textContent="Hide details",o=s(),i=e("i"),a(n,"class","txt"),a(i,"class","ri-arrow-up-s-line")},m(f,h){m(f,n,h),m(f,o,h),m(f,i,h)},d(f){f&&(u(n),u(o),u(i))}}}function je(d){let n,o,i,f,h,r,b,$,C,g,p,tt,kt,zt,E,Kt,H,rt,R,et,ne,Q,U,oe,ct,yt,lt,vt,ae,dt,pt,st,N,Jt,Ft,y,nt,Lt,Vt,At,j,ot,Tt,Wt,Pt,F,ft,Rt,ie,ut,re,M,Ot,at,St,O,mt,ce,z,Et,Xt,Nt,de,q,Yt,K,ht,pe,I,fe,B,ue,P,qt,J,bt,me,gt,he,x,Dt,it,Ht,be,Mt,Zt,V,_t,ge,It,_e,wt,we,W,G,xe,xt,te,X,ee,L,Y,S,Bt,$e,Z,v,Gt;return{c(){n=e("p"),n.innerHTML=`The syntax basically follows the format
