import{S as lt,i as st,s as nt,a9 as at,aa as tt,R as K,h as r,d as W,t as j,a as J,I as ve,a0 as Ge,a1 as ot,C as it,ab as rt,D as dt,l as d,n as l,m as X,u as a,A as _,v as b,c as Y,w as m,J as Ke,p as ct,k as Z,o as pt}from"./index-CGZL2Fjn.js";import{F as ut}from"./FieldsQueryParam-DQYOizuM.js";function We(o,s,n){const i=o.slice();return i[6]=s[n],i}function Xe(o,s,n){const i=o.slice();return i[6]=s[n],i}function Ye(o){let s;return{c(){s=a("p"),s.innerHTML="Requires superuser <code>Authorization:TOKEN</code> header",m(s,"class","txt-hint txt-sm txt-right")},m(n,i){d(n,s,i)},d(n){n&&r(s)}}}function Ze(o,s){let n,i,v;function p(){return s[5](s[6])}return{key:o,first:null,c(){n=a("button"),n.textContent=`${s[6].code} `,m(n,"class","tab-item"),Z(n,"active",s[2]===s[6].code),this.first=n},m(c,f){d(c,n,f),i||(v=pt(n,"click",p),i=!0)},p(c,f){s=c,f&20&&Z(n,"active",s[2]===s[6].code)},d(c){c&&r(n),i=!1,v()}}}function et(o,s){let n,i,v,p;return i=new tt({props:{content:s[6].body}}),{key:o,first:null,c(){n=a("div"),Y(i.$$.fragment),v=b(),m(n,"class","tab-item"),Z(n,"active",s[2]===s[6].code),this.first=n},m(c,f){d(c,n,f),X(i,n,null),l(n,v),p=!0},p(c,f){s=c,(!p||f&20)&&Z(n,"active",s[2]===s[6].code)},i(c){p||(J(i.$$.fragment,c),p=!0)},o(c){j(i.$$.fragment,c),p=!1},d(c){c&&r(n),W(i)}}}function ft(o){var Ne,Qe;let s,n,i=o[0].name+"",v,p,c,f,w,C,ee,N=o[0].name+"",te,$e,le,F,se,B,ne,$,Q,ye,V,T,we,ae,z=o[0].name+"",oe,Ce,ie,Fe,re,I,de,S,ce,x,pe,R,ue,Re,M,D,fe,De,be,Oe,h,Pe,E,Te,Ee,Ae,me,Be,_e,Ie,Se,xe,he,Me,qe,A,ke,q,ge,O,H,y=[],He=new Map,Le,L,k=[],Ue=new Map,P;F=new at({props:{js:`
