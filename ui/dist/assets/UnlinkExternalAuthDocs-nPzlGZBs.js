import{S as Oe,i as De,s as Me,O as j,b as d,d as Be,t as oe,a as ae,r as I,Q as Te,R as We,g as ze,T as He,e as Le,f as u,h as a,m as Ue,n as i,u as g,k as f,c as qe,o as b,C as Re,p as je,w as N,x as Ie,N as Ne}from"./index-CrEs8Q1a.js";import{S as Ke}from"./SdkTabs-CiFRtEit.js";function Ae(n,l,o){const s=n.slice();return s[5]=l[o],s}function Ce(n,l,o){const s=n.slice();return s[5]=l[o],s}function Ee(n,l){let o,s=l[5].code+"",_,h,c,p;function m(){return l[4](l[5])}return{key:n,first:null,c(){o=i("button"),_=g(s),h=f(),b(o,"class","tab-item"),N(o,"active",l[1]===l[5].code),this.first=o},m($,P){u($,o,P),a(o,_),a(o,h),c||(p=Ie(o,"click",m),c=!0)},p($,P){l=$,P&4&&s!==(s=l[5].code+"")&&I(_,s),P&6&&N(o,"active",l[1]===l[5].code)},d($){$&&d(o),c=!1,p()}}}function Se(n,l){let o,s,_,h;return s=new Ne({props:{content:l[5].body}}),{key:n,first:null,c(){o=i("div"),qe(s.$$.fragment),_=f(),b(o,"class","tab-item"),N(o,"active",l[1]===l[5].code),this.first=o},m(c,p){u(c,o,p),Ue(s,o,null),a(o,_),h=!0},p(c,p){l=c;const m={};p&4&&(m.content=l[5].body),s.$set(m),(!h||p&6)&&N(o,"active",l[1]===l[5].code)},i(c){h||(ae(s.$$.fragment,c),h=!0)},o(c){oe(s.$$.fragment,c),h=!1},d(c){c&&d(o),Be(s)}}}function Qe(n){var _e,ke,ge,ve;let l,o,s=n[0].name+"",_,h,c,p,m,$,P,M=n[0].name+"",K,se,ne,Q,F,T,G,E,J,w,W,ie,z,y,ce,V,H=n[0].name+"",X,re,Y,de,Z,ue,L,x,S,ee,B,te,U,le,A,q,v=[],pe=new Map,me,O,k=[],be=new Map,C;T=new Ke({props:{js:`
