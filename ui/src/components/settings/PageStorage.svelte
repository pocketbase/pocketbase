                            ...
                            <Field class="form-field" name="s3.forcePathStyle" let:uniqueId>
                                ...
                                <label for={uniqueId}>
                                    ...
                                    <i
                                        ...
                                        use:tooltip={{
                                            text: 'Enable to force the request to use path-style addressing, eg. "https://s3.amazonaws.com/BUCKET/KEY" instead of the default "https://BUCKET.s3.amazonaws.com/KEY".',
                                            position: "top",
                                        }}
                                    />
                                </label>
