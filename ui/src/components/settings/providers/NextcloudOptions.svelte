...
<div class="section-title">Nextcloud OIDC Endpoints</div>
<div class="grid">
    <div class="col-lg-12">
        <Field class="form-field required" name="{key}.authUrl" let:uniqueId>
            ...
            <div class="help-block">Eg. https://nextcloud.your.domain/index.php/apps/oidc/authorize</div>
        </Field>
    </div>
    <div class="col-lg-12">
        <Field class="form-field required" name="{key}.tokenUrl" let:uniqueId>
            ...
            <div class="help-block">Eg. https://nextcloud.your.domain/index.php/apps/oidc/token</div>
        </Field>
    </div>
    <div class="col-lg-12">
        <Field class="form-field required" name="{key}.userApiUrl" let:uniqueId>
            ...
            <div class="help-block">Eg. https://nextcloud.your.domain/index.php/apps/oidc/userinfo</div>
        </Field>
    </div>
</div>
