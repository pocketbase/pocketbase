...
interface ColorField extends core.ColorField{} // merge
/**
  * {@inheritDoc core.ColorField}
  * @group PocketBase
*/
declare class ColorField implements core.ColorField {
  constructor(data?: Partial<core.ColorField>)
}
