...
import (
	...
	"github.com/lilysnc/pocketbasepg/plugins/jsvm"
...
func main() {
	...
	gen := tygoja.New(tygoja.Config{
		Packages: map[string][]string{
			...
			"github.com/lilysnc/pocketbasepg/tools/template":   {"*"},
			"github.com/lilysnc/pocketbasepg/tokens":           {"*"},
			"github.com/lilysnc/pocketbasepg/mails":            {"*"},
			"github.com/lilysnc/pocketbasepg/apis":             {"*"},
			"github.com/lilysnc/pocketbasepg/forms":            {"*"},
