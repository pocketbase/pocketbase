...
namespace hook {
  ...
  */
 type _subjCWii<T> = mainHook<T>
 interface TaggedHook<T> extends _subjCWii<T> {
 }
...
namespace hook {
  ...
  */
 type _subbXNDX<T> = Hook<T>
 interface mainHook<T> extends _subbXNDX<T> {
 }
}
...
namespace reflect {
  ...
  */
 type _subqOOuW = flag
 interface Value extends _subqOOuW {
 }
 interface Value {
  /**
