...
func TestSettingsValidate(t *testing.T) {
	...
	s.AzureAuth.Enabled = true
	s.AzureAuth.ClientId = ""
...
func TestSettingsMerge(t *testing.T) {
	...
	s2.AzureAuth.Enabled = true
	s2.AzureAuth.ClientId = "azure_test"
...
func TestSettingsRedactClone(t *testing.T) {
	...
	s1.AzureAuth.ClientSecret = "test123"
...
func TestNamedAuthProviderConfigs(t *testing.T) {
	...
	s.AzureAuth.ClientId = "azure_test"
	...
	expected := `{"azure":{"enabled":false,"clientId":"azure_test"},"discord":{"enabled":false,"clientId":"discord_test"},"facebook":{"enabled":false,"clientId":"facebook_test"},"github":{"enabled":false,"clientId":"github_test"},"gitlab":{"enabled":true,"clientId":"gitlab_test"},"google":{"enabled":false,"clientId":"google_test"},"twitter":{"enabled":false,"clientId":"twitter_test"}}`
