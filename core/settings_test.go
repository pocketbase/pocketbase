...
func TestSettingsMerge(t *testing.T) {
	...
	s2.MicrosoftAuth.ClientId = "microsoft_ad_test"
...
func TestNamedAuthProviderConfigs(t *testing.T) {
	...
	expected := `{"discord":{"enabled":false,"clientId":"discord_test"},"facebook":{"enabled":false,"clientId":"facebook_test"},"github":{"enabled":false,"clientId":"github_test"},"gitlab":{"enabled":true,"clientId":"gitlab_test"},"google":{"enabled":false,"clientId":"google_test"},"twitter":{"enabled":false,"clientId":"twitter_test"},"microsoft":{"enabled":false,"clientId":"microsoft_test"}}`
