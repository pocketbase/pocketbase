...
func TestSettingsValidate(t *testing.T) {
	...
	s.NextcloudAuth.Enabled = true
	s.NextcloudAuth.ClientId = ""
...
func TestSettingsMerge(t *testing.T) {
	...
	s2.NextcloudAuth.Enabled = true
	s2.NextcloudAuth.ClientId = "nextcloud_test"
...
func TestSettingsRedactClone(t *testing.T) {
	...
	s1.NextcloudAuth.ClientSecret = "test123"
...
func TestNamedAuthProviderConfigs(t *testing.T) {
	...
	s.NextcloudAuth.ClientId = "nextcloud_test"
	...
	expectedParts := []string{
		...
		`"nextcloud":{"enabled":false,"clientId":"nextcloud_test"}`,
	}
