...
func TestSettingsValidate(t *testing.T) {
	...
	s.WeChatAuth.Enabled = true
	s.WeChatAuth.ClientId = ""
...
func TestSettingsMerge(t *testing.T) {
	...
	s2.WeChatAuth.Enabled = true
	s2.WeChatAuth.ClientId = "wechat_test"
...
func TestSettingsRedactClone(t *testing.T) {
	...
	s1.WeChatAuth.ClientSecret = testSecret
...
func TestNamedAuthProviderConfigs(t *testing.T) {
	...
	s.WeChatAuth.ClientId = "wechat_test"
	...
	expectedParts := []string{
		...
		`"wechat":{"enabled":false,"clientId":"wechat_test"`,
	}
