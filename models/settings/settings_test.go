...
func TestSettingsMerge(t *testing.T) {
	...
	s2.RedditAuth.Enabled = true
	s2.RedditAuth.ClientId = "reddit_test"
...
func TestSettingsRedactClone(t *testing.T) {
	...
	s1.RedditAuth.ClientSecret = "test123"
