...
func TestSettingsValidate(t *testing.T) {
	...
	s.TelegramAuth.Enabled = true
	s.TelegramAuth.BotToken = ""
...
func TestSettingsMerge(t *testing.T) {
	...
	s2.TelegramAuth.Enabled = true
	s2.TelegramAuth.BotToken = "telegram_test"
...
func TestSettingsRedactClone(t *testing.T) {
	...
	s1.TelegramAuth.BotToken = "test123"
...
func TestTgAuthProviderConfigValidate(t *testing.T) {
	scenarios := []struct {
		config      settings.TgAuthProviderConfig
		expectError bool
	}{
		// zero values (disabled)
		{
			settings.TgAuthProviderConfig{},
			false,
		},
		// zero values (enabled)
		{
			settings.TgAuthProviderConfig{Enabled: true},
			true,
		},
		// invalid data
		{
