...
func TestSettingsMerge(t *testing.T) {
	...
	s2.Hubspot.Enabled = true
	s2.Hubspot.ClientId = "hubspot_test"
...
func TestSettingsRedactClone(t *testing.T) {
	...
	s1.Hubspot.ClientSecret = "test123"
...
func TestNamedAuthProviderConfigs(t *testing.T) {
	...
	s.Hubspot.ClientId = "hubspot_test"
	...
	expectedParts := []string{
		...
		`"hubspot":{"enabled":false,"clientId":"hubspot_test"}`,
	}
